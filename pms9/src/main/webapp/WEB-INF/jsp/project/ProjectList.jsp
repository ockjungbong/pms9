            ...
            <div class="panel panel-default"> 
            	<div class="panel-body">
					<div class="listHead">
						...
						<div class="listHiddenField pull-right field100"><s:message code="project.crdate"/></div>
						<div class="listHiddenField pull-right field100"><s:message code="project.usernm"/></div>
						<div class="listTitle"><s:message code="project.crtitle"/></div>
					</div>
